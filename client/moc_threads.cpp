...
void listener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (listener::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&listener::message)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject listener::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_listener.data,
...
// SIGNAL 0
void listener::message(QString _t1)
{
